...
# E (exit of the encoding input): Symbol that shows starting of decoding output
# P(padding symbol): Symbol that will fill in blank sequence if current batch data size is short than time steps
